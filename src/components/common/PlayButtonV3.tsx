...
const PlayButtonV3 = ({ style, id, title, audioUri, imageUri, author, isPremium = false }: any) => {
    ...
    return (
        <TouchableOpacity onPress={() => onPlay({ id, title, url: audioUri, artwork: imageUri, artist: author })}>
            <Animated.View style={[
                style,
                {
                    height:          30,
